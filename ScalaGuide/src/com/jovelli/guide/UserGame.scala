...
class FreeUser(val name: String, val score: Int, val upgradeProbability: Double) extends UserGame
...
class PremiumUser(val name: String, val score: Int) extends UserGame
